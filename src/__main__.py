...
def main() -> None:
    ...
    model_folder = os.path.join(args.m, 'Dataset%s_Task%s_dlicv/nnUNetTrainer__nnUNetPlans__3d_fullres/' % (args.d, args.d))
    ...
    predictor.predict_from_files(des_folder,
                                 args.o,
    ...
    for filename in files:
         if filename.endswith('.nii.gz'):
              ...
              os.rename(os.path.join(files_folder, filename), os.path.join(files_folder, original_name))
